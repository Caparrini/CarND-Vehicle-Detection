...
class BaseOptimizer(object):
    ...
    def __init__(self, features, labels):
        ...
        :param features:
        :param labels: to train and test the classifier
        """
    ...
    def evaluateClf(self, individual):
        ...
        mean, std = KFoldAccuracy(self.features, self.labels, self.getClf(individual))
    ...
    def plotLogbook(self, logbook):
        ...
        name = (str(self).split(".")[1]).split(" ")[0]
        plt.savefig(str(name)+"optfig")
...
class TreeOptimizer(BaseOptimizer):
    ...
    def getClf(self, individual):
        ...
        clf = DecisionTreeClassifier(criterion="gini",
                                     ...
                                     max_features=None,
                                     max_depth=None,
                                     min_impurity_decrease=individual[0],
